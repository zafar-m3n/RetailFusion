...
class ProcessingComplaintPage extends StatelessWidget {
              ...
              SafeArea(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildHeading(textColor, 'Complaint Summary'),
                    Container(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  ...
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(text: 'October 13, 2023 15:45'),
                            ],
                          ),
                        )),
                    ...
                    _buildHeading(textColor, 'Complaint Details'),
                    Container(
                        padding: EdgeInsets.all(10),
                        decoration: BoxDecoration(
                          border: Border.all(color: textColor),
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  ...
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                  text: 'Defective Product in Order #A03233\n'),
                              TextSpan(
                                  text: 'Category/Type: ',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(text: 'Product Defect\n'),
                              TextSpan(
                                  text: 'Priority: ',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              ...
                              TextSpan(
                                  text:
                                      'Received a defective item in order #A03233. The product\'s left earpiece isn\'t working. This was meant for a gift. Seeking a prompt resolution, either a replacement or a refund.'),
                            ],
                          ),
                        )),
                    Row(
